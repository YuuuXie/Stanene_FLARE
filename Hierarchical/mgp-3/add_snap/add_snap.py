...
if __name__ == '__main__':
    # load gp model
    gp_model = pickle.load(open('../../mgp-2/train_hyps/stn_2_trained.gp.pickle', 'rb'))

    # training dft data
    path = '../../mgp-2/dft/'
    scf_pwi = [path+'1000/1000ps.xyz', path+'1750/1750ps.xyz', path+'3000/3000ps.xyz']
    scf_pwo = [path+'1000/scf.pwo', path+'1750/scf.pwo', path+'3000/scf.pwo']
    ...
    # save gp model 
    gp_model.write_model('stn_3_original.gp', format='pickle')
